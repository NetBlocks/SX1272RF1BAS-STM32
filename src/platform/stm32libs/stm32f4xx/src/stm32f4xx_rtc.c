...
/**
  ...
  */
ErrorStatus RTC_Init_STLib(RTC_InitTypeDef* RTC_InitStruct)
{
  ErrorStatus status = ERROR;
...
/**
  ...
  */
ErrorStatus RTC_SetTime_STLib(uint32_t RTC_Format, RTC_TimeTypeDef* RTC_TimeStruct)
{
  uint32_t tmpreg = 0;
  ErrorStatus status = ERROR;
...
/**
  ...
  * @retval None
  */
void RTC_GetTime_STLib(uint32_t RTC_Format, RTC_TimeTypeDef* RTC_TimeStruct)
{
  uint32_t tmpreg = 0;
